...
export default function Catalog() {
    ...
    return (
        <div className="pt-20 min-h-screen bg-white  transition-colors">
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">

                {/* Header */}
                <div className="flex justify-between items-center mb-8">
                    <h1 className="font-display font-bold text-4xl uppercase  transition-colors">Colección</h1>
                    <button
                        className="md:hidden flex items-center gap-2 font-bold uppercase text-sm border-b border-black  pb-1  transition-colors"
                ...
                <div className="flex gap-12">
                    ...
                    <aside className="hidden md:block w-64 shrink-0">
                        <div className="sticky top-24">
                            <h3 className="font-bold text-lg mb-6 uppercase border-b border-gray-200  pb-2  transition-colors">Filtros</h3>
